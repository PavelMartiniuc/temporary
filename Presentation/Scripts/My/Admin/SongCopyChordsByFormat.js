...
function cancelFormat()
{
    ...
    function pasteChords()
    {
        ...
        var selectionLen = selectionArray.length;

        var maxlen = chordsLen > selectionLen ? selectionLen : chordsLen;
       ...
       resultStringChords = resultStringChords.replace(/\n+$/g, '');
       ...
       // var submitedTextlength = resultStringChords.split('\n');
